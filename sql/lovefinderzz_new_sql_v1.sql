...
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`user` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`type` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`tags` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`place` (
...
--   INDEX `fk_place_type_idx` (`type_id` ASC),
    CONSTRAINT `fk_place_type`
        FOREIGN KEY (`type_id`)
        REFERENCES `Lovefinderzz`.`type` (`id`)
        ON DELETE NO ACTION -- default type??
        ON UPDATE CASCADE ,
    CONSTRAINT 'fk_place_user'
        FOREIGN KEY ('created_by')
        REFERENCES 'Lovefinderzz'.'user' ('id')
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`comments` (
...
--   INDEX `fk_comments_place1_idx` (`place_id` ASC),
  ...
  CONSTRAINT `fk_comments_place`
    ...
    REFERENCES `Lovefinderzz`.`place` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lovefinderzz`.`place_has_tags` (
  `place_id` INTEGER NOT NULL,
...
--   INDEX `fk_place_has_tags_place1_idx` (`place_id` ASC),
  ...
  CONSTRAINT `fk_place_has_tags_tags`
    FOREIGN KEY (`tags_id`)
    REFERENCES `Lovefinderzz`.`tags` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
